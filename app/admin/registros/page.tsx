...
export default function RegistrosPage() {
  ...
  return (
    <CrudPage
      ...
      selectQuery="idregistro_proceso, fecha_inicio, fecha_fin, notas, idproceso, idusuario, lote_cafe:idlote_cafe(variedad), proceso:idproceso(nombre), usuario:idusuario(nombre)"
