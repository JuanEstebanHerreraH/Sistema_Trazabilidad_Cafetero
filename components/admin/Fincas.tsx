  ...
  return (
    <CrudPage
      ...
      columns={[
        ...
        { key: 'area_hectareas', label: 'Área (ha)', sortable: true, render: v => v ? `${v} ha` : '—' },
      ]}
      fields={[
      ...
      filterSelects={[
        { key: 'idproductor', label: 'Productor',
          options: productores.map(p => ({ value: String(p.idproductor), label: p.nombre })) },
      ]}
      rangeFilters={[
